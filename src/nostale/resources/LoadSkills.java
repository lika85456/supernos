					...
					if (currentLine.length > 2 && currentLine[1].equals("VNUM")) {
						...
						case "0":
							...
							if (currentLine[3].equals("81")) {
								skill.SkillChance = Short.parseShort(currentLine[5]); // abs
																						// *
																						// 4
								skill.BuffId = Short.parseShort(currentLine[6]);
							} else {
						...
						case "1":
							skill.ElementalDamage = Short.parseShort(currentLine[5]); // Divide
																						// by
																						// 4(?)

							// skill.Unknown =cskill.Unknown =
							// Short.parseShort(currentLine[2]);
							// skill.Unknown = Short.parseShort(currentLine[3]);
							// skill.Unknown =
							// Short.parseShort(currentLine[4]); skill.Unknown =
							// Short.parseShort(currentLine[6]); skill.Unknown =
							// Short.parseShort(currentLine[7]);
							break;
