...
/**
 * This class represents an AbstractNode. It has all the appropriate fields as
 * well as getter and setter to be used by the A* algorithm.
 * <p>
 * <p>
 * An <code>AbstractNode</code> has x- and y-coordinates and can be walkable or
 * not. A previous AbstractNode may be set, as well as the <code>fCosts</code>,
 * <code>gCosts</code> and <code>hCosts</code>.
 * <p>
 * <p>
 * <code>fCosts</code>: <code>gCosts</code> + <code>hCosts</code>
 * <p>
 * <code>gCosts</code>: calculated costs from start AbstractNode to this
 * AbstractNode
 * <p>
 * <code>hCosts</code>: estimated costs to get from this AbstractNode to end
 * AbstractNode
 * <p>
 * <p>
 ...
 * <p>
 * 
 * @see ExampleNode#sethCosts(AbstractNode endNode) example Implementation using
 *      manhatten method
 *      <p>
 *
 * @version 1.0
...
public abstract class AbstractNode {
	...
	/**
	 * returns weather or not the move from the
	 * <code>previousAbstractNode</code> was diagonally. If it is not diagonal,
	 * it is sideways.
	 *
	 * @return
	 */
	...
	/**
	 * sets weather or not the move from the <code>previousAbstractNode</code>
	 * was diagonally. If it is not diagonal, it is sideways.
	 *
	 * @param isDiagonaly
	 */
	...
	/**
	 * returns the calculated costs from start AbstractNode to this
	 * AbstractNode.
	 *
	 * @return the gCosts
	 */
	...
	/**
	 * sets gCosts to <code>gCosts</code> plus <code>movementPanelty</code> for
	 * this AbstractNode.
	 *
	 * @param gCosts
	 *            the gCosts to set
	...
	/**
	 * sets gCosts to <code>gCosts</code> plus <code>movementPanelty</code> for
	 * this AbstractNode given the previous AbstractNode as well as the basic
	 * cost from it to this AbstractNode.
	 *
	...
	/**
	 * sets gCosts to <code>gCosts</code> plus <code>movementPanelty</code> for
	 * this AbstractNode given the previous AbstractNode.
	 * <p>
	 * It will assume <code>BASICMOVEMENTCOST</code> as the cost from
	 * <code>previousAbstractNode</code> to itself if the movement is not
	 * diagonally, otherwise it will assume <code>DIAGONALMOVEMENTCOST</code>.
	...
	/**
	 * returns estimated costs to get from this AbstractNode to end
	 * AbstractNode.
	 *
	 * @return the hCosts
	 */
	...
	/**
	 * calculates hCosts for this AbstractNode to a given end AbstractNode. Uses
	 * Manhatten method.
	 *
	...
	public String toString() {
		return "(" + getxPosition() + ", " + getyPosition() + "): h: " + gethCosts() + " g: " + getgCosts() + " f: "
				+ getfCosts();
	}
